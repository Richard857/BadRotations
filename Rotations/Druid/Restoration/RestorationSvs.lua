...
local function createOptions()
    ...
    -- Cooldown Options
        ...
        -- Innervate
            br.ui:createSpinner(section, "激活",  60,  0,  100,  5,  "多少血量百分比使用") 
            br.ui:createSpinner(section, "激活目标数量",  3,  0,  40,  1,  "","最低多少个人才使用激活", true)			
    ...
    -- Healing Options
        ...
        -- Efflorescence
            br.ui:createSpinner(section, "百花齐放",  90,  0,  100,  5,  "|cffFFFFFF多少血量百分比使用")
            br.ui:createSpinnerWithout(section, "百花齐放目标数量",  2,  0,  40,  1,  "放置百花齐放的目标数量")
            br.ui:createSpinnerWithout(section, "百花齐放重放延迟", 20, 1, 30, 1, colorWhite.."百花齐放重放延迟多少秒.")
        ...
        -- Ironbark
            ...
            br.ui:createDropdownWithout(section, "铁木树皮 目标", {"|cffFFFFFF自己","|cffFFFFFF目标", "|cffFFFFFF鼠标位置", "|cffFFFFFF坦克", "|cffFFFFFF奶妈", "|cffFFFFFF奶妈/坦克", "|cffFFFFFF所有人"}, 7, "|cffFFFFFF使用迅捷治愈的目标")	
        -- Swiftmend
            br.ui:createSpinner(section, "迅捷治愈", 30, 0, 100, 5, "","多少血量百分比使用")
            br.ui:createDropdownWithout(section, "迅捷治愈 目标", {"|cffFFFFFF自己","|cffFFFFFF目标", "|cffFFFFFF鼠标位置", "|cffFFFFFF坦克", "|cffFFFFFF奶妈", "|cffFFFFFF奶妈/坦克", "|cffFFFFFF所有人"}, 7, "|cffFFFFFF使用迅捷治愈的目标")				
        -- Rejuvenaion
        ...
        -- Regrowth
            br.ui:createSpinner(section, "愈合",  80,  0,  100,  5,  "","|cffFFFFFF多少血量百分比使用")
	        br.ui:createSpinner(section, "紧急愈合",  35,  0,  100,  5,  "","|cffFFFFFF多少血量会优先使用愈合", true)
        ...
        -- Wild Growth
            br.ui:createSpinner(section, "野性成长",  80,  0,  100,  5,  "","多少血量百分比使用") 
            br.ui:createSpinner(section, "野性成长目标数量",  3,  0,  40,  1,  "","最低多少个人才使用野性成长", true)            
        -- Essence of G'Hanir
            br.ui:createSpinner(section, "加尼尔的精华",  70,  0,  100,  5,  "","多少血量百分比使用") 
            br.ui:createSpinner(section, "加尼尔的精华目标数量",  3,  0,  40,  1,  "","最低多少个人才使用加尼尔的精华", true)
        -- Flourish
            br.ui:createSpinner(section, "繁盛",  60,  0,  100,  5,  "","多少血量百分比使用") 
            br.ui:createSpinner(section, "繁盛目标数量",  3,  0,  40,  1,  "","最低多少个人到达血量百分比才使用繁盛", true)
            br.ui:createSpinner(section, "繁盛回春数量",  3,  0,  40,  1,  "","最低多少个人有回春才使用繁盛", true)			
        br.ui:checkSectionState(section)
    -- Toggle Key Options
