...
function br.read.combatLog()
    ...
    frame:RegisterEvent("COMBAT_LOG_EVENT_UNFILTERED")
        ...
        ---------------
        --[[ Debug --]]
        if getOptionCheck("运行日志") == true and source == br.guid and (param == "SPELL_CAST_SUCCESS" or (param == "SPELL_CAST_FAILED" and getOptionCheck("显示失败"))) then
            -- available locals
